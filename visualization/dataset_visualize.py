...
dataset_path = 'data/dataset1/train'
...
def plot_all_trajectories(envType, save_path=DEFAULT_PREDICTIONS_DIR):
    """
    绘制指定环境中的所有轨迹在同一张图上
    Args:
        envType: str 环境类型/名称
...
def plot_trajectory_heatmap(envType, save_path=DEFAULT_PREDICTIONS_DIR, grid_size=100):
    """
    绘制轨迹热力图，显示路径密度分布
    Args:
        envType: str 环境类型/名称
