...
| `tests/legacy/test_cost_conditioned_dit.py` | 完整测试脚本 |
| `docs/legacy/CostConditionedPathDiffusionTransformer_Usage.md` | 详细使用文档 |
...
详细使用说明见：`docs/legacy/CostConditionedPathDiffusionTransformer_Usage.md`
