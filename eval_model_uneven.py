...
def get_patch(model, start_pos, goal_pos, normal_x, normal_y, normal_z):
    ...
    try:
        ...
        # predVal, correctionVal, *_ = model(map_input[None,:].cuda(),pose_input[None,:].cuda())  # Shape: (batch_size, channels, height, width) -> (batch_size, num_tokens, output_dim), (batch_size, num_tokens, 3, output_dim)
